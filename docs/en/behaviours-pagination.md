...
To connect these buttons you must declare behaviour `pagination` in field `\bestyii\swiper\Swiper::$behaviours`, 
otherwise pagination will not be rendered.

> Note: to pagination was clickable, you must specify `paginationClickable = true` 
  in field `\bestyii\swiper\Swiper::$pluginOptions`
...
You can configure pagination through the field `\bestyii\swiper\Swiper::$paginationOptions`. 

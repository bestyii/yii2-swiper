...
You can configure parallax through the field `\bestyii\swiper\Swiper::$parallaxOptions`, similar to `\yii\helpers\BaseHtml::tag`

> Pay attention: to parallax get worked, 
  you should declare option `parallax = true` in field `\bestyii\swiper\Swiper::$pluginOptions`
